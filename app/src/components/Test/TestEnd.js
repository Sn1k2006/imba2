              ...
              <View style={{flexDirection: 'row', alignItems: 'center', marginTop: 32}}>
                ...
                <ShadowView style={[Styles.shadow, styles.mark_shadow]}>
                  <View style={{overflow: 'hidden'}}>
                    <Text
                      style={styles.mark}>{translate('YOUR_POINTS')} {Math.floor((test_results?.percent || 0) / 10)} </Text>
                  </View>
                </ShadowView>
                {test_end === 'passed'
                  ?
                  <TouchableWithoutFeedback
                    ...
                    hitSlop={{top: 15, bottom: 15, left: 15, right: 15}}>
                    <ShadowView
                      style={[Styles.shadow, styles.about_test, this.getAchieve() ? {} : styles.disable_achive]}>
                      <View>
